...
for edge in alignment_graph.edges(data=True):
    ...
    cluster1 = alignment_graph.nodes[node1]['mcl_cluster']
    cluster2 = alignment_graph.nodes[node2]['mcl_cluster']
...
for cluster, subgraph in cluster_subgraphs.items():
    ...
    if len(subgraph.nodes()) > 1:
        ...
        filename = f'AlignNemo/results/mcl/e5_i3/cluster_{cluster}.gml'
